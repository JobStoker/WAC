...
function deleteCountry(code){
	...
	fetch('http://localhost:8080/firstapp/restservices/countries/' + code, {method: 'DELETE', headers : {	'Authorization': 'Bearer ' + window.sessionStorage.getItem("sessionToken") }})
		.then((response) => {
...
function updateCountry(){
	...
	fetch("http://localhost:8080/firstapp/restservices/countries/" + code, {method: 'PUT', body: encData, headers : {	'Authorization': 'Bearer ' + window.sessionStorage.getItem("sessionToken") }})
	.then((myJson) => {
		console.log(myJson);
	});
...
function addCountry(){
	...
	fetch('http://localhost:8080/firstapp/restservices/countries', {method: 'POST', body: encData, headers : {	'Authorization': 'Bearer ' + window.sessionStorage.getItem("sessionToken") }})
	.then((response) => {
